...
RAT::Methods::SDecompBK::SDecompBK()
{
// Default constructor
   fNIpiv = 0;
   fIpiv  = 0;
...
//______________________________________________________________________________
RAT::Methods::SDecompBK::SDecompBK(Int_t nrows)
{
...
//______________________________________________________________________________
RAT::Methods::SDecompBK::SDecompBK(Int_t row_lwb,Int_t row_upb)
{
...
//______________________________________________________________________________
RAT::Methods::SDecompBK::SDecompBK(const TMatrixDSym &a,Double_t tol)
{
...
//______________________________________________________________________________
RAT::Methods::SDecompBK::SDecompBK(const SDecompBK &another) : TDecompBase(another)
{
// Copy constructor
...
//______________________________________________________________________________
Bool_t RAT::Methods::SDecompBK::Decompose()
{
...
//______________________________________________________________________________
void RAT::Methods::SDecompBK::SetMatrix(const TMatrixDSym &a)
{
...
//______________________________________________________________________________
Bool_t RAT::Methods::SDecompBK::Solve(TVectorD &b)
{
...
//______________________________________________________________________________
Bool_t RAT::Methods::SDecompBK::Solve(TMatrixDColumn &cb)
{
// Solve Ax=b assuming the BK form of A is stored in fU . Solution returned in b.
...
//______________________________________________________________________________
Bool_t RAT::Methods::SDecompBK::Invert(TMatrixDSym &inv)
{
...
//______________________________________________________________________________
TMatrixDSym RAT::Methods::SDecompBK::Invert(Bool_t &status)
{
// For a symmetric matrix A(m,m), its inverse A_inv(m,m) is returned .
...
//______________________________________________________________________________
void RAT::Methods::SDecompBK::Print(Option_t *opt) const
{
...
//______________________________________________________________________________
RAT::Methods::SDecompBK &RAT::Methods::SDecompBK::operator=(const RAT::Methods::SDecompBK &source)
{
// Assigment operator
