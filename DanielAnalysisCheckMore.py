...
#### !!!! Becareful that TF2 must exist then it is fair to do this cut
...
ntuple = TNtuple("ntupleFailTF2","fail tf2","runID:subrunID:eventID:type")
                                ...
                                if cft2r<0.04 and cfb3r<0.1: ## level 11
                                     ...
                                     if mbZ<550:## level 12
                                       ...
                                       if data.pulseindexfirstgar>2: ## level 13
                                          ...
                                          badcheck = -9999999
                                          if (tf2X == badcheck or tf2Y == badchek or tf2Z == badcheck):
                                              ntuple.Fill(runID, subrunID, eventID, 0)
                                              ## print "tf2 is not valid, check the results carefully!!!"
        
                                          if (tf2cerenkovX == badcheck or tf2cerenkovY == badchek or tf2cerenkovZ == badcheck):
                                              ntuple.Fill(runID, subrunID, eventID, 1)
