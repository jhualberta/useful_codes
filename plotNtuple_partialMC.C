{
  TString fname = "Merged_PartialScintNeck_FillPo210_Avinnerdust_200runs.ntuple.root";
  ...
  TH2F *hnhitCleanVsX = new TH2F("hnhitCleanVsX","nhitCleaned vs X",2000,-9000,9000,1000,0,1000);
  TH2F *hnhitCleanVsY = new TH2F("hnhitCleanVsY","nhitCleaned vs Y",2000,-9000,9000,1000,0,1000);
  TH2F *hnhitCleanVsZ = new TH2F("hnhitCleanVsZ","nhitCleaned vs Z",2000,-9000,9000,1000,0,1000);
  TH2F *hnhitCleanVsR = new TH2F("hnhitCleanVsR","nhitCleaned vs R",1000,0,9000,1000,0,1000);

  TTree* output = (TTree*)ff->Get("output");
  output->Project("hskyShine","skyShine","partialFit  && nhitsCleaned>10");

  output->Project("hskyVsNhits","skyShine:nhitsCleaned", "partialFit");

  output->Project("hskyVsZ","skyShine:posz", "partialFit && nhitsCleaned>10");
  output->Project("hskyVsZ_Nhit50","skyShine:posz", "partialFit  && nhitsCleaned>50");
  output->Project("hskyVsZ_Nhit100","skyShine:posz", "partialFit  && nhitsCleaned>100");

  output->Project("hskyVsR","skyShine:posr", "partialFit  && nhitsCleaned>10");
  output->Project("hskyVsR_Nhit50","skyShine:posr", "partialFit  && nhitsCleaned>50");
  output->Project("hskyVsR_Nhit100","skyShine:posr", "partialFit  && nhitsCleaned>100");

  output->Project("hRhoZ","posz:sqrt(posx*posx+posy*posy)", "partialFit  && nhitsCleaned>10");
  output->Project("hRhoZ_nhit50","posz:sqrt(posx*posx+posy*posy)", "partialFit  && nhitsCleaned>50");
  output->Project("hRhoZ_nhit100","posz:sqrt(posx*posx+posy*posy)", "partialFit  && nhitsCleaned>100");

  output->Project("hyz","posz:posy","partialFit  && nhitsCleaned>10"); 
  output->Project("hxy","posx:posy","partialFit  && nhitsCleaned>10"); 

  output->Project("hyz_sky1","posz:posy","partialFit  && nhitsCleaned>10 && skyShine>1");
  output->Project("hxy_sky1","posx:posy","partialFit  && nhitsCleaned>10 && skyShine>1"); 

  output->Project("hyz_sky1p6","posz:posy","partialFit  && nhitsCleaned>10 && skyShine>1.6");
  output->Project("hxy_sky1p6","posx:posy","partialFit  && nhitsCleaned>10 && skyShine>1.6");

  output->Project("hyz_sky1p6Nhit50","posz:posy","partialFit  && nhitsCleaned>50 && skyShine>1.6");
  output->Project("hxy_sky1p6Nhit50","posx:posy","partialFit  && nhitsCleaned>50 && skyShine>1.6");

  output->Project("hyz_sky1p6Nhit100","posz:posy","partialFit  && nhitsCleaned>100 && skyShine>1.6");
  output->Project("hxy_sky1p6Nhit100","posx:posy","partialFit  && nhitsCleaned>100 && skyShine>1.6");

  output->Project("hyz_sky2","posz:posy","partialFit  && nhitsCleaned>10 && skyShine>2");
  output->Project("hxy_sky2","posx:posy","partialFit  && nhitsCleaned>10 && skyShine>2");
  ///
  output->Project("hyz_nhit50","posz:posy","partialFit  && nhitsCleaned>50");
  output->Project("hxy_nhit50","posx:posy","partialFit  && nhitsCleaned>50");

  output->Project("hyz_nhit100","posz:posy","partialFit  && nhitsCleaned>100");
  output->Project("hxy_nhit100","posx:posy","partialFit  && nhitsCleaned>100");

/// Leon analysis
  output->Project("hyz_leon","(posz-108):posy","partialFit  && nhitsCleaned>10 && skyShine>1 && sqrt(posx*posx+posy*posy+(posz-108)*(posz-108))<6000 && (posz-108)>5100 && posx<100 && posx>-100");


  output->Project("hnhitCleanVsX","nhitsCleaned:posx","partialFit");
  output->Project("hnhitCleanVsY","nhitsCleaned:posy","partialFit");
  output->Project("hnhitCleanVsZ","nhitsCleaned:posz","partialFit");
  output->Project("hnhitCleanVsR","nhitsCleaned:sqrt(posx*posx+posy*posy+posz*posz)","partialFit");
