...
void fitMar2020Te()
{
  TFile *f1 = new TFile("/media/vphys/seagate/TeMeasure_mar2020/labppo/plots_caen_coin.root");
  TFile *f2 = new TFile("/media/vphys/seagate/TeMeasure_mar2020/Te1p0/plots_caen_coin.root");
  ROOT::Math::MinimizerOptions::SetDefaultMinimizer("GSLMultiFit");
  h1 = (TH1F*)f1->Get("e2d_cor_px");
  h2 = (TH1F*)f2->Get("e2d_cor_px");
...
//-------------------------- Fit sample1----------------------------
  int fitstartbin = 100;// range for total fit function
  int range1 = 700;
