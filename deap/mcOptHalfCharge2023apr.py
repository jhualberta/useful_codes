...
# updated 2017
#### NOTE: mc code, don't use PMTinfo!! otherwise it will break
...
for Files in AllFiles:
        ...
        for event in range(nentries):
                ...
                if DS.GetTSCount() > 0 and DS.GetEVCount() > 0 and DS.GetCALCount() > 0:
                       ...
                       if nSelected<1:
                           print "too few selected PMTs, no obvious hit points, pass this event !!!"
                           count_ncluster = 0
                           continue
