...
# updated 2023
# to run: python OptHalfCharge2023apr.py /project/6004969/data/v5.14.0/cal/run030627/deap_cal_030627_0000.root
...
fout = TFile("Opt2023noQcut_"+fileName,"RECREATE");
...
##NOTE: pmt.qPrompt is default!!
charge1 = array('f',Nmax*[0]) #pmt.qPrompt
chargeNSCB1 = array('f',Nmax*[0])
chargeQPE1 = array('f',Nmax*[0])
#tagCluster1 = array('i',[0])

#### pmt by pmt, cluster 2
nPMTs2 = array('i',[0])
nPulse2 = array('i', [0])
nSubpeaks2 = array('i',[0])
...
subpeaktime2 = array('f', Nmax*Nsubpeak*[0])
##NOTE: pmt.qPrompt is default!!
charge2 = array('f',Nmax*[0])
chargeNSCB2 = array('f',Nmax*[0])
chargeQPE2 = array('f',Nmax*[0])
#tagCluster2 = array('i',[0])

#### pmt by pmt, cluster 3
nPMTs3 = array('i',[0])
nPulse3 = array('i', [0])
nSubpeaks3 = array('i',[0])
...
subpeaktime3 = array('f', Nmax*Nsubpeak*[0])
##NOTE: pmt.qPrompt is default!!
charge3 = array('f',Nmax*[0]) #pmt.qPrompt
chargeNSCB3 = array('f',Nmax*[0])
chargeQPE3 = array('f',Nmax*[0])
...
tree1.Branch("nSubpeaks", nSubpeaks1, "nSubpeaks/I")
#tree1.Branch("subpeaktime", subpeaktime1, "subpeaktime[nPMTs][nSubpeaks]/F")
tree1.Branch("charge", charge1, "charge[nPMTs]/F")
tree1.Branch("chargeNSCB", chargeNSCB1, "chargeNSCB[nPMTs]/F")
tree1.Branch("chargeQPE", chargeQPE1, "chargeQPE[nPMTs]/F")
...
tree2.Branch("numEarlyPulses", numEarlyPulsesVal,"numEarlyPulses/F")
tree2.Branch("subeventN",  subeventNval, " subeventN/F")
...
tree2.Branch("nPulse", nPulse2, "nPulse/I")
tree2.Branch("nSubpeaks", nSubpeaks2, "nSubpeaks/I")
tree2.Branch("subpeaktime", subpeaktime2, "subpeaktime[nPMTs][nSubpeaks]/F")
tree2.Branch("charge", charge2, "charge[nPMTs]/F")
tree2.Branch("chargeNSCB", chargeNSCB2, "chargeNSCB[nPMTs]/F")
tree2.Branch("chargeQPE", chargeQPE2, "chargeQPE[nPMTs]/F")
...
tree3.Branch("numEarlyPulses", numEarlyPulsesVal,"numEarlyPulses/F")
tree3.Branch("subeventN",  subeventNval, " subeventN/F")
...
tree3.Branch("nPulse", nPulse3, "nPulse/I")
tree3.Branch("nSubpeaks", nSubpeaks3, "nSubpeaks/I")
tree3.Branch("subpeaktime", subpeaktime3, "subpeaktime[nPMTs][nSubpeaks]/F")
tree3.Branch("charge", charge3, "charge[nPMTs]/F")## pmt charge
tree3.Branch("chargeNSCB", chargeNSCB3, "chargeNSCB[nPMTs]/F")
tree3.Branch("chargeQPE", chargeQPE3, "chargeQPE[nPMTs]/F")
...
HsubpkTime_cluster1  = TH1F("HsubpkTime_cluster1","subpeakTime single",4000,1000,5000)
HsubpkTime_cluster2a = TH1F("HsubpkTime_cluster2a","subpeakTime double1",4000,1000,5000)
HsubpkTime_cluster2b = TH1F("HsubpkTime_cluster2b","subpeakTime double2",4000,1000,5000)

HsubpkTime_qpromptWt_cluster1  = TH1F("HsubpkTime_qpromptWt_cluster1","subpeakTime qprompt weight single",4000,1000,5000) 
HsubpkTime_qpromptWt_cluster2a = TH1F("HsubpkTime_qpromptWt_cluster2a","subpeakTime qprompt weight double1",4000,1000,5000)
HsubpkTime_qpromptWt_cluster2b = TH1F("HsubpkTime_qpromptWt_cluster2b","subpeakTime qprompt weight double2",4000,1000,5000)

HsubpkTime_qnscbWt_cluster1  = TH1F("HsubpkTime_qnscbWt_cluster1","subpeakTime qnscb weight single",4000,1000,5000)
HsubpkTime_qnscbWt_cluster2a = TH1F("HsubpkTime_qnscbWt_cluster2a","subpeakTime qnscb weight double1",4000,1000,5000)
HsubpkTime_qnscbWt_cluster2b = TH1F("HsubpkTime_qnscbWt_cluster2b","subpeakTime qnscb weight double2",4000,1000,5000)

HsubpkTime_qpeWt_cluster1  = TH1F("HsubpkTime_qpeWt_cluster1","subpeakTime qpe weight single",4000,1000,5000)
HsubpkTime_qpeWt_cluster2a = TH1F("HsubpkTime_qpeWt_cluster2a","subpeakTime qpe weight double1",4000,1000,5000)
HsubpkTime_qpeWt_cluster2b = TH1F("HsubpkTime_qpeWt_cluster2b","subpeakTime qpe weight double2",4000,1000,5000)

#################### time residual #######################
HtimeRes_cluster1  = TH1F("HtimeRes_cluster1","timeRes single",4000,-1000,3000)
HtimeRes_cluster2a = TH1F("HtimeRes_cluster2a","timeRes double1",4000,-1000,3000)
HtimeRes_cluster2b = TH1F("HtimeRes_cluster2b","timeRes double2",4000,-1000,3000)

HtimeRes_qpromptWt_cluster1  = TH1F("HtimeRes_qpromptWt_cluster1","timeRes qprompt weight single",4000,-1000,3000)
HtimeRes_qpromptWt_cluster2a = TH1F("HtimeRes_qpromptWt_cluster2a","timeRes qprompt weight double1",4000,-1000,3000)
HtimeRes_qpromptWt_cluster2b = TH1F("HtimeRes_qpromptWt_cluster2b","timeRes qprompt weight double2",4000,-1000,3000)

HtimeRes_qnscbWt_cluster1  = TH1F("HtimeRes_qnscbWt_cluster1","timeRes qnscb weight single",4000,-1000,3000)
HtimeRes_qnscbWt_cluster2a = TH1F("HtimeRes_qnscbWt_cluster2a","timeRes qnscb weight double1",4000,-1000,3000)
HtimeRes_qnscbWt_cluster2b = TH1F("HtimeRes_qnscbWt_cluster2b","timeRes qnscb weight double2",4000,-1000,3000)

HtimeRes_qpeWt_cluster1  = TH1F("HtimeRes_qpeWt_cluster1","timeRes qpe weight single",4000,-1000,3000)
HtimeRes_qpeWt_cluster2a = TH1F("HtimeRes_qpeWt_cluster2a","timeRes qpe weight double1",4000,-1000,3000)
HtimeRes_qpeWt_cluster2b = TH1F("HtimeRes_qpeWt_cluster2b","timeRes qpe weight double2",4000,-1000,3000)
...
for event in range(nentries):
        ...
        if DS.GetTSCount() > 0 and DS.GetEVCount() > 0 and DS.GetCALCount() > 0:
               ...
               if ( CAL.GetQPE() <= 100               ):  continue; # Skip events that have no charge information (primarily pre-scaled events)
               ...
               charges = {}; charges_nscb = {}; charges_qpe = {};
               savePMTid = []; pmtTime = {}; ### time of each PMT
               ...
               for ipmt in range (CAL.GetPMTCount()): ### loop PMTs
                       ...
                       q = PMT.qPE
                       qNSCB   = PMT.nscBayes
                       qPrompt = PMT.qPrompt/spe

                       if not(q>0): continue
                       if not(qPrompt>0): continue
                       if not(qNSCB>0): continue

                       #specharge = PMTInfoUtil().GetSPECharge(PMTid) # James
                       ###NOTE: default algorithm used PMT.qPrompt, without /spe. 
                       charges[PMTid] = qPrompt
                       charges_nscb[PMTid] = qNSCB 
                       charges_qpe[PMTid] = q
               ...
               if flag_single == True:
                    ...
                    for kk in range(nPMTs1[0]):
                           ...
                           charge1[kk] = charges[pmtid] #pmt.qPrompt
                           ...
                           for time in saveAllSubpeakTime[pmtid]:
                               ...
                               HsubpkTime_qpromptWt_cluster1.Fill( time, charge1[kk] )
                               ...
                               HtimeRes_qpromptWt_cluster1.Fill( time-CalTrigTime, charge1[kk])
