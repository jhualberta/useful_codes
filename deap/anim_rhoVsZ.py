...
h2d_0 = f.Get("H2_rhoZ_0");	
h2d_1 = f.Get("H2_rhoZ_1");	
h2d_2 = f.Get("H2_rhoZ_2");	
h2d_3 = f.Get("H2_rhoZ_3");	
h2d_4 = f.Get("H2_rhoZ_4");	
h2d_5 = f.Get("H2_rhoZ_5");	
h2d_6 = f.Get("H2_rhoZ_6");	
h2d_7 = f.Get("H2_rhoZ_7");	
h2d_8 = f.Get("H2_rhoZ_7_neck");	
h2d_9 = f.Get("H2_rhoZ_7_neck_fmaxpe");
h2d_10 = f.Get("H2_rhoZ_7_neck_fmaxpe_mbR");	
h2d_11 = f.Get("H2_rhoZ_7_str_qRatio");
h2d_12 = f.Get("H2_rhoZ_7_str_qRatio_mbZ");
h2d_13 = f.Get("H2_rhoZ_str_qRatio_mbZ_pulseG");
...
h2d_10.SetMarkerStyle(20)
h2d_11.SetMarkerStyle(20)
h2d_12.SetMarkerStyle(20)
h2d_13.SetMarkerStyle(20)
...
gSystem.Unlink("rhoZ_levelCuts2D.gif");
...
for i in range(plotNum):
   if ((i%kUPDATE) == 0): 
     ...
     c1.Print("rhoZ_levelCuts2D.gif+200");
## slider.SetRange(0,1);
