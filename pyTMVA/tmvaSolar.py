...
inputfile = "../MixedDataSet_MP_r200004to200658_4to5MeV.root"
f0 = TFile(inputfile)
...
method = factory.BookMethod(ROOT.TMVA.Types.kBDT, "BDT", ":".join(["!H","!V", "PDFInterpol=Spline2","NTrees=nTrain", "nEventsMin=nTest", "MaxDepth=3", "BoostType=AdaBoost", "AdaBoostBeta=0.5", "SeparationType=GiniIndex","nCuts=1", "PruneMethod=NoPruning", ]))
...
ROOT.TestTree.Draw("BDT>>hSig(22,-1.1,1.1)","classID == 0","gon")#"goff")  # signal
ROOT.TestTree.Draw("BDT>>hBg(22,-1.1,1.1)","classID == 1", "gon")#"goff")  # background
