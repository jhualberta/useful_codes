{
  ...
  gz_chi->SetMarkerSize(1.5);gz_chi->SetMarkerStyle(21);gz_chi->SetRangeUser(0,2);

  TGraph *MCgz_chi = new TGraph(nz,z,zMC_chi);
  MCgz_chi->SetMarkerSize(1.5);MCgz_chi->SetMarkerStyle(24);MCgz_chi->SetRangeUser(0,2);
...
//
  ...
  gy_chi->SetMarkerSize(1.5);gy_chi->SetMarkerStyle(21);gy_chi->SetRangeUser(0,2);

  TGraph *MCgy_chi = new TGraph(ny,y,yMC_chi);
  MCgy_chi->SetMarkerSize(1.5);MCgy_chi->SetMarkerStyle(24);MCgy_chi->SetRangeUser(0,2);
  //x scan 
//
  ...
  gx_chi->SetMarkerSize(1.5);gx_chi->SetMarkerStyle(21);gx_chi->SetRangeUser(0,2);
  TGraph *MCgx_chi = new TGraph(nx,x,xMC_chi);
  MCgx_chi->SetMarkerSize(1.5);MCgx_chi->SetMarkerStyle(24);MCgx_chi->SetRangeUser(0,2);
///////////////////////////////////////////////////////////
